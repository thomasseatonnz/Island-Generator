...
public class SimplexNoise { // Simplex noise in 2D, 3D
	...
	static void newSeed(long s) {
		seed = s;
		rand = new Random(seed);

		perm = new short[num];
		permMod12 = new short[num];
	...
	public static double OctaveSimplex(double x, double y, int octaves, double persistence, double f, double a) {
		double total = 0;
		double frequency = f;
		double amplitude = a;
	...
	public static double OctaveSimplex(double x, double y, double z, int octaves, double persistence) {
		double total = 0;
		double frequency = 1;
		double amplitude = 1;
		double maxValue = 0; // Used for normalizing result to 0.0 - 1.0
